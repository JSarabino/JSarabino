...
HTML | CSS | JavaScript | TypeScript | Angular | React | Bootstrap | TailwindCSS

### Backend

Java | Spring Boot | Spring Data JPA | Node.js | Express.js | TypeScript | APIs REST | JWT
...
Git | GitHub | Docker | Postman | Figma | Jira

### Arquitectura y buenas prácticas

Microservicios | Domain-Driven Design | CQRS | Outbox Pattern | Arquitectura Hexagonal | Modelo C4 | Metodologías Ágiles
...
* Oracle Cloud Infrastructure - ONE AI FOR TECH
* Inteligencia de Datos y RAG Avanzado - ONE AI FOR TECH
* Ingeniería de Agentes y Automatización con IA - ONE AI FOR TECH
* Desarrollo y Orquestación con IA Generativa - ONE AI FOR TECH
